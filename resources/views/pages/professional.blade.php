...
@section('content')
    ...
    <section class="benefits-section">
      <h2>Professional Membership <span>Benefits</span></h2>
      <div style="text-align: center; margin-bottom: 48px;">
        <h3 style="color: #E09900; font-size: 28px; margin-bottom: 16px;">Professional Membership Fee: P1,000</h3>
        <p style="font-size: 18px; color: #4b5563;">Unlock exclusive opportunities and advance your multimedia arts career</p>
      </div>
      ...
      <div class="benefits-grid">
        <div class="benefit-card">
          ...
          <p>Be part of the bigger landscape of multimedia arts in the country. Represent and be represented in matters of policy, industry development, and positive change in the industry.</p>
        </div>
        ...
        <div class="benefit-card">
          ...
          <h3>Network</h3>
          <p>Tap into a national network of emerging and veteran professionals, gain insights, lessons, and advice from people who have been where you're headed; contribute to a greater body of knowledge to benefit all.</p>
        </div>
        ...
        <div class="benefit-card">
          ...
          <h3>Engage</h3>
          <p>Collaborate with others on projects and activities; link up with professionals and practitioners to fill in the gaps in your personal skill set or complete your production team.</p>
        </div>
        ...
        <div class="benefit-card">
          ...
          <h3>Access</h3>
          <p>Gain first-dibs on the newest and latest innovations and developments in the field and tap into member-only pricing, deals, and arrangements. Find out before the rest of the internet does.</p>
        </div>
        ...
        <div class="benefit-card">
          ...
          <h3>Support</h3>
          <p>We know it's not easy to be a Creative in the Philippines. Training in sustainable business practices, professional wellness, and government compliance are just a taste of things to come. We'll help out with the management, you focus on the Creatives. We got your back.</p>
        </div>
        ...
        <div class="benefit-card">
          ...
          <p>With our numbers as a professional organization we can leverage on products and services usually unavailable to freelancers, individuals, or small studios. Healthcare, insurance, group pricing, and legal services… we've got those lined up.</p>
        </div>
      </div>
    </section>
