...
@section('content')
  ...
  <style>
    ...
    <section class="benefits-section">
      <h2>Calling institutions and companies!
Represent. Empower. Connect.
 <span>Partner with MMAAP today!</span></h2>
      ...
      <div class="benefits-grid">
        <div class="benefit-card">
          ...
          <h3>Help us REPRESENT</h3>
          <p>We seek partners in government and industry, partners that will help us grow as an institution and organization to benefit the greatest number of Creatives in the most sustainable manner possible</p>
        </div>
        ...
        <div class="benefit-card">
          ...
          <h3>Help us EMPOWER</h3>
          <p>We seek partners in education, support, and development; partners that will help us help other Creatives in areas such as skills and talent development, support services, and product development</p>
        </div>
        ...
        <div class="benefit-card">
          ...
          <h3>Help us CONNECT</h3>
          <p>We seek partners to bring Filipino Creatives together and to link these same Creatives to clients and services around the world.</p>
        </div>
        ...
        <h3 style="color: #E09900; font-size: 28px; margin-bottom: 16px;">Want to know how to be an Industry Partner?</h3>
        <p style="font-size: 18px; color: #4b5563;">Send us an email at hello@mmaap.com.ph</p>
      </div>
