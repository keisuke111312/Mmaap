    ...
    <nav class="main-nav sticky-nav">
        <div class="nav-container">
            <ul class="nav-items">
                ...
                <li class="nav-item">
                    <a
                        href="{{ route('resource.management') }}"class="nav-link {{ request()->routeIs('resource.management') ? 'active' : '' }}">
                        <span class="nav-icon"><i class="fab fa-github"></i> </i></span>
                        RESOURCES
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{route('community.moderator')}}"
                        class="nav-link {{ request()->routeIs('community.moderator') ? 'active' : '' }}">
